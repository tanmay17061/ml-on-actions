import argparse
import logging
from mlonactions.pipelines import train_pipeline, add_new_samples_pipeline, data_and_model_monitoring_and_testing_pipeline
...
def build_data_and_model_monitoring_and_testing_parser(parser):
...
def main():
    ...
    data_and_model_monitoring_and_testing_parser = subparsers.add_parser("data_and_model_monitoring")
    build_data_and_model_monitoring_and_testing_parser(data_and_model_monitoring_and_testing_parser)
    ...
    if args.command == "data_and_model_monitoring":
        data_and_model_monitoring_and_testing_pipeline(args)
